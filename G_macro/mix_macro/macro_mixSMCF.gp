...
plot './1vs1/SMCF.txt' using ($1*($4)**g):($2*($4)**(b*g)) w p pt 3 lc 3, h(P) w l lc 3
...
replot './3vs1/SMCF.txt' using ($1*($4)**g31):($2*($4)**(b31*g31)) w p pt 2 lc 2, h31(P) w l lc 2 
...
replot './1vs0/SMCF.txt' using ($1*($4)**g10):($2*($4)**(b10*g10)) w p pt 1 lc 1, h10(P) w l lc 1 
...
replot './1vs3/SMCF.txt' using ($1*($4)**g13):($2*($4)**(b13*g13)) w p pt 4 lc 4, h13(P) w l lc 4
