...
A=10**C
GPFUN_h = "h(P)=A*(P+B)**b"
replot './1vs1/SMCF.txt' using ($1*($4)**g):($2*($4)**(b*g)) w p pt 3 lc 3 notitle, h(P) w l lc 3 title '1:1'
...
replot './1vs3/SMCF.txt' using ($1*($4)**g13):($2*($4)**(b13*g13)) w p pt 4 lc 4 notitle, h13(P) w l lc 4 title '1:3'
