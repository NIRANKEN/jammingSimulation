...
set yrange [ 0.000100000 : 0.010000 ] noreverse nowriteback
...
plot './3vs1/PHIJstatinfo.txt' using 1:4 w p ps 3 pt 1 lw 3 lc rgb '#00994d' notitle,g31(N) w l lw 1.5 lc rgb '#00994d' title '3:1'
...
A11=10**B11
replot './1vs1/PHIJstatinfo.txt' using 1:4 w p pt 2 ps 3 lw 3 lc rgb '#ff7f00' notitle,g11(N) w l lw 1.5 lc rgb '#b366ff' title '1:1'
...
A13=10**B13
replot './1vs3/PHIJstatinfo.txt' using 1:4 w p pt 4 ps 3 lw 3 lc rgb '#b366ff' notitle,g13(N) w l lw 1.5 lc rgb '#ff7f00' title '1:3'
