...
plot '3vs1/SMCFtmp.txt' using ($1*($4)**g):((($5+(1.0-$5)*1.4**3)**(0.5))*$2*($4)**(b*g)) w p pt 1 ps 2.5 lw 2 lc rgb '#00994d' title '3:1', '1vs1/SMCFtmp.txt' using ($1*($4)**g):((($5+(1.0-$5)*1.4**3)**(0.5))*$2*($4)**(b*g)) w p pt 2 ps 2.5 lw 2 lc rgb '#ff7f00' title '1:1','1vs3/SMCFtmp.txt' using ($1*($4)**g):((($5+(1.0-$5)*1.4**3)**(0.5))*$2*($4)**(b*g)) w p pt 4 ps 2.5 lw 1.5 lc rgb '#b366ff' title '1:3', h(P) w l lc 8 lw 1.5 title 'fitting line'
