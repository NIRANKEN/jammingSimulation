...
echo $2 BI $4 $3 $dir1 $dir2 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir3 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir4 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir5 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir6 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir7 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir8 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir9 | ./F_ifreq
echo $2 BI $4 $3 $dir1 $dir10 | ./F_ifreq
...
echo "CharacteristicFrequency2_EIGEnsAve_BR0.05_"$2"_"$3"BIN"$4".txt $2 BI $4 $3" > sin_addBIN_bi_
